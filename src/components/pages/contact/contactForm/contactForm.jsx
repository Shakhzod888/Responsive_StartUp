...
import { Burger, Input, Textarea } from "@mantine/core";
    ...
    <section className="contact_section_1">
      ...
      >
        <div>
          ...
          <Link className="activeALink " to="/contact">
            Contact
          </Link>
        </div>
      </div>
          ...
          <nav className="section_1_nav ">
            ...
            <div className="nav_rigth">
              <ul>
                ...
                <li>
                  <Link className="activeLink" to="/contact">
                    Contact
                  </Link>
                </li>
                <Burger
      ...
      <div className="section_contact">
        <div className="container">
          <div>
            <p className="plans">CONTACT</p>
            <p className="portfolio_text">Contact Us</p>
          ...
          <div className="contact_form">
            ...
            <div>
              <AspectRatio className="contact_map" ratio={16 / 9}>
                <iframe
