    ...
    <section className="services_section_1">
      ...
      >
        <div>
          ...
          <Link className="activeALink " to="/services">
            Services
          </Link>
          <Link to="/contact">Contact</Link>
        </div>
      </div>
      <div className="porftfolio_header">
          ...
          <nav className="section_1_nav ">
            ...
            <div className="nav_rigth">
              <ul>
                ...
                <li>
                  <Link className="activeLink" to="/services">
                    Services
                  </Link>
                </li>
                <li>
      ...
      <div className="container">
        <div className="section_plans">
          <div>
            ...
            <p className="portfolio_text">Our Services</p>
            <p className="portfolio_main_text">
      ...
      <div className="home_footer">
        <div className="container">
          <div className="footer_links">
            ...
            <div className="about_text_footer">
