...
import Work_7 from "../assets/work_7.jpg";
...
function Works() {
  ...
  return (
    <section className="portfolio_section_1">
      <div
      ...
      >
        <div>
          <Link to="/">Home</Link>
          <Link className="activeALink " to="/portfolio">
            Portfolio
          </Link>
          ...
          <nav className="section_1_nav ">
            ...
            <div className="nav_rigth">
              <ul>
                ...
                <li>
                  <Link className="activeLink" to="/portfolio">
                    Portfolio
                  </Link>
                </li>
                <li>
